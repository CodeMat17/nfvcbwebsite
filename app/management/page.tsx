    ...
    <>
      ...
      <section className="relative py-24 bg-nfvcb-dark overflow-hidden">
        ...
        <div className="relative z-10 section">
          <AnimatedSection>
            <Badge className="mb-4 bg-primary/20 text-primary border-primary/30">Leadership</Badge>
            <h1 className="text-h1 font-black text-white mb-4">Management Team</h1>
      ...
      <div className="section py-16">
                ...
                <Card className="overflow-hidden border-primary/20 py-0">
                  <div className="relative h-96 bg-gradient-to-br from-nfvcb-dark to-primary/40 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 p-4 z-10">
                      <Badge className="bg-accent text-nfvcb-dark font-semibold mb-1.5 text-xs">
                        {title}
                      </Badge>
        ...
        {/* Executive Director */}
        <AnimatedSection className="mb-16">
          <div className="relative rounded-3xl overflow-hidden border border-accent/30 bg-gradient-to-br from-nfvcb-dark to-nfvcb-dark">
            ...
            <div className="relative grid md:grid-cols-[auto_1fr] gap-0">
              ...
              <div className="relative w-full md:w-72 lg:w-80 h-80 md:h-auto shrink-0 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-nfvcb-dark/80 via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:to-nfvcb-dark/60" />
                <div className="absolute bottom-4 left-4 md:hidden">
                  <Badge className="bg-accent text-nfvcb-dark font-bold text-xs mb-1">Executive Director / CEO</Badge>
                ...
                <div className="flex flex-wrap gap-3 text-xs">
                  {[
                    ...
                    <div key={sub} className="px-4 py-2 rounded-xl border border-white/10 bg-white/5 text-center min-w-[72px]">
                      <p className="text-accent font-bold text-base">{label}</p>
